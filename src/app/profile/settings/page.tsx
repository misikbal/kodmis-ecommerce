            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-500">Sipariş durumu ve önemli güncellemeler</p>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-sm font-medium text-gray-900">Pazarlama Bildirimleri</h3>
                  <p className="text-sm text-gray-500">Kampanya ve özel teklifler</p>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
                    type="checkbox"
